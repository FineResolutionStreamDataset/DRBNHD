...
for partition in partitions:
    outfile = f"D:/river/river-dl/results/results_progress_upscaling/{MODEL_NAME}/preds/{basin}_{maskpercentage_formatted}_{partition}_{model_seed}_preds.feather"
    ensure_dir(outfile)
...
for metric_type in metric_types:
    ...
    outfile = f"D:/river/river-dl/results/results_progress_upscaling/{MODEL_NAME}/metrics/{metric_type}/{basin}_{maskpercentage_formatted}_{model_seed}_metrics.csv"
    ensure_dir(outfile)
    combined_metrics(obs_file=config['obs_file_NHD'],
                     ...
                     pred_trn=f"D:/river/river-dl/results/results_progress_upscaling/{MODEL_NAME}/preds/{basin}_{maskpercentage_formatted}_trn_{model_seed}_preds.feather",
                     pred_val=f"D:/river/river-dl/results/results_progress_upscaling/{MODEL_NAME}/preds/{basin}_{maskpercentage_formatted}_val_{model_seed}_preds.feather",
                     pred_tst=f"D:/river/river-dl/results/results_progress_upscaling/{MODEL_NAME}/preds/{basin}_{maskpercentage_formatted}_tst_{model_seed}_preds.feather",
